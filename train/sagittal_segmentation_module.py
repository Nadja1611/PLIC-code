...
Thalamus = np.load("Labels_thalamus.npz")
...
os.chdir('.\\')
X_train = preprocessing_sagittal(X,Y,indices,thalamus_training,thalamus_val)[0]
Y_train=preprocessing_sagittal(X,Y,indices,thalamus_training,thalamus_val)[1]
X_val=preprocessing_sagittal(X,Y,indices,thalamus_training,thalamus_val)[2]
Y_val=preprocessing_sagittal(X,Y,indices,thalamus_training,thalamus_val)[3]
