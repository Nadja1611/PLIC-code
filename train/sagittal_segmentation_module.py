...
os.chdir('.\\')
X = preprocessing_sagittal_crossvalidation(X_train,Y_train,indices,thalamus)[0]
Y=preprocessing_sagittal_crossvalidation(X_train, Y_train,indices,thalamus)[1]
